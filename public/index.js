...
//  var modalReserveButton = document.getElementsByClassName('modal-reserve-button')[0];
//  modalReserveButton.addEventListener('click', reserveAction)
//  modalReserveButton.addEventListener('click', reserveSpace);
